...
m4 = this.vwr.getSymStatic().staticGetMatrixTransform(s);
} else {
m4 = this.vwr.getSymTemp().convertTransform(s, null);
}break;
case 7:
...
}return (m4 != null && (asABC || asXYZ) ? mp.addXStr(this.matToString(m4, asABC)) : mp.addXM4(m4));
...
var isSubgroups = (n > 1 && (n != 2 || !"settings".equalsIgnoreCase(mode) && !"list".equalsIgnoreCase(mode)));
...
if (index1 < 0 || index1 == 2147483647) return false;
case 3:
itaTo = args[1].intValue;
if (itaTo == 2147483647) {
itaTo = this.vwr.getItaNumberFor(args[1].asString());
}if (itaTo < 0) return false;
case 2:
itaFrom = args[0].intValue;
if (itaFrom == 2147483647) {
itaFrom = this.vwr.getItaNumberFor(args[0].asString());
...
return mp.addXObj(this.vwr.findSpaceGroup(null, null, xyzList, ucParams, null, null, 1));
...
return mp.addXObj(this.vwr.getSymStatic().getSpaceGroupInfoObj(xyzList, params, true, false));
}, "JS.ScriptMathProcessor,~A");
...
;//5.0.1-v4 Thu Sep 12 21:01:09 CDT 2024
