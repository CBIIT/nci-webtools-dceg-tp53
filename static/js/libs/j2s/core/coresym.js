...
var n = list.size();
var groups = (asIntArray ?  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0) : null);
...
return (trms.get(index2 - 1)).get("trm");
}
...
function(){
if (this.symmetryInfo != null) return this.symmetryInfo.getDerivedSpaceGroup().getClegId();
...
Clazz_declarePackage("JS");
Clazz_load(["JS.HallInfo", "java.util.Hashtable"], "JS.SpaceGroup", ["java.util.Arrays", "JU.AU", "$.Lst", "$.M4", "$.P3", "$.PT", "$.SB", "JS.SymmetryOperation", "$.UnitCell", "JU.Logger"], function(){
var c$ = Clazz_decorateAsClass(function(){
...
sb.append("\n\n").appendI(this.operationCount).append(" operators").append(this.hallInfo != null && !this.hallInfo.getHallSymbol().equals("--") ? " from Hall symbol " + this.hallInfo.getHallSymbol() + "  #" + this.jmolId : "").append(": ");
for (var i = 0; i < this.operationCount; i++) {
...
var sg = lst.get(i);
if (sg.clegId == null || clegId == null || clegId.equals("0:a,b,c") || sg.clegId.equals(clegId)) if (JS.SpaceGroup.getCanonicalSeitz(sg.index).indexOf(s) >= 0) return JS.SpaceGroup.SG[sg.index];
}
return null;
}, "~N,~S,~S");
...
;//5.0.1-v4 Thu Sep 12 21:06:50 CDT 2024
Clazz_declarePackage("JS");
Clazz_load(["JU.P3"], "JS.SpaceGroupFinder", ["JU.BS", "$.Lst", "$.M4", "$.PT", "JS.SpaceGroup", "$.Symmetry", "$.SymmetryOperation", "$.UnitCell", "JU.BSUtil", "JV.FileManager"], function(){
var c$ = Clazz_decorateAsClass(function(){
this.vwr = null;
this.uc = null;
this.sg = null;
...
}this.sg = JS.SpaceGroup.nameToGroup.get(JU.PT.trim(JS.SpaceGroupFinder.groupNames[this.isg], "0"));
}return this.sg;
});
...
;//5.0.1-v4 Tue Sep 10 10:47:48 CDT 2024
Clazz_declarePackage("JS");
...
var a = Math.abs(x);
return (a < 0.0001 ? "" : (x < 0 ? "-" : strT.length == 0 ? "" : "+") + (a > 0.9999 ? "" : a < 1 && allowFractions ? JS.SymmetryOperation.twelfthsOf(a * 12) : "" + Clazz_floatToInt(a))) + sx;
}, "~S,~N,~S,~B");
...
;//5.0.1-v4 Tue Sep 10 17:38:50 CDT 2024
Clazz_declarePackage("JS");
...
;//5.0.1-v4 Tue Sep 10 11:29:28 CDT 2024
Clazz_declarePackage("JS");
Clazz_load(["java.util.Hashtable", "JU.P3", "$.V3"], "JS.WyckoffFinder", ["JU.JSJSONParser", "$.M4", "$.Measure", "$.P4", "$.PT", "$.Rdr", "$.SB", "JS.SpaceGroup", "$.SymmetryOperation", "JV.FileManager"], function(){
var c$ = Clazz_decorateAsClass(function(){
this.positions = null;
this.npos = 0;
this.ncent = 0;
...
if (helper == null) {
helper = JS.WyckoffFinder.createHelper(this, vwr, cleg);
}if (helper == null) {
...
;//5.0.1-v4 Thu Sep 12 21:06:25 CDT 2024
Clazz_declarePackage("JS");
Clazz_load(["JU.M4"], "JS.CLEG", ["java.util.Arrays", "JU.AU", "$.BS", "$.P3", "$.PT", "JS.SV", "JS.UnitCell", "JV.Viewer"], function(){
...
c$.isClegSetting = Clazz_defineMethod(c$, "isClegSetting", 
function(name){
var p = name.indexOf(":");
return (p > 0 && JS.CLEG.isInt(name, p) && name.indexOf(",") > p ? p : 0);
}, "~S");
c$.checkSyntax = Clazz_defineMethod(c$, "checkSyntax", 
function(tokens, sym){
...
c$.isCalcType = Clazz_defineMethod(c$, "isCalcType", 
function(token){
...
this.mkWsNode = false;
this.mkIndex = 0;
Clazz_instantialize(this, arguments);}, JS.CLEG, "AssignSGParams", null);
Clazz_makeConstructor(c$, 
function(vwr){
this.vwr = vwr;
